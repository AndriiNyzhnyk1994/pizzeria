...
import { SortPropertyEnum, SortType, selectFilterSort, setSort } from "../redux/slices/filterSlice"
...
function SortPopUp() {
  ...
  // для точной типизации ref указываем неверный тип,
  // затем смотрим на подходящий тип в ошибке внутри jsx кода
